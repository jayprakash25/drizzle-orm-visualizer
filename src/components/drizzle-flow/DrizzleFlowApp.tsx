...
import { PanelLeftOpen, VectorSquare } from 'lucide-react';
      ...
      {showExpandButton && (
        <div className="absolute top-4 left-4 z-50 animate-in fade-in slide-in-from-left-2 duration-300 ease-out">
          ...
          >
            ...
            <span className="ml-2 font-medium">Show Input</span>
          </Button>
        </div>
      )}
                ...
                <div className="flex items-center gap-4">
                  {parseResult?.success && parseResult.data && (
                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                      <span>{parseResult.data.tables.length} Tables</span>
                  ...
                  <div className="text-center space-y-4 fade-in">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm max-w-md text-muted-foreground">
                        Enter your Drizzle ORM schema in the input panel to see the visualization.
                        The parser will analyze your tables, columns, and relationships.
                      </p>
                    </div>
                  </div>
                </div>
